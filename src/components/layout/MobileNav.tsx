...
const SOLO_MAIN = [
  { icon: '📊', he: 'Home', href: '/dashboard' },
  { icon: '🧑', he: 'Customers', href: '/customers' },
  { icon: '📄', he: 'Quotes', href: '/quotes' },
  { icon: '✅', he: 'Closings', href: '/closings' },
  { icon: '☰', he: 'More', href: '#more' },
];

const SOLO_MORE = [
  { icon: '🧾', he: 'Receipts', href: '/receipts' },
  { icon: '⚙️', he: 'Settings', href: '/settings' },
];
