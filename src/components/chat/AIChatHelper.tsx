      ...
      {!isOpen && (
        <Box
          ...
          sx={{
            ...
            height: 56,
            borderRadius: '50%',
            background: 'linear-gradient(135deg, #4F46E5, #00a882)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            cursor: 'pointer',
            boxShadow: '0 8px 32px rgba(0,229,176,0.35), 0 0 0 1px rgba(79,70,229,0.25)',
            ...
            '@keyframes chatPulse': {
              '0%': { boxShadow: '0 8px 32px rgba(0,229,176,0.35), 0 0 0 0 rgba(79,70,229,0.25)' },
          ...
          >
            <TextField
              ...
              sx={{
                '& .MuiOutlinedInput-root': {
                  ...
                  '&.Mui-focused fieldset': { borderColor: 'rgba(0,229,176,0.4)', boxShadow: '0 0 0 3px rgba(79,70,229,0.08)' },
                },
            ...
            <IconButton
              ...
              sx={{
                ...
                height: 40,
                borderRadius: '12px',
                bgcolor: input.trim() ? 'linear-gradient(135deg, #4F46E5, #00a882)' : c.glass2,
                background: input.trim() ? 'linear-gradient(135deg, #4F46E5, #00a882)' : c.glass2,
