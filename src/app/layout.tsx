...
export const metadata: Metadata = {
  title: IS_SOLO_EDITION ? 'Zikkit — Quotes, Receipts & Closings' : 'Zikkit',
  description: IS_SOLO_EDITION ? 'Customers, quotes, receipts and closings for field service pros.' : 'AI-Powered Field Service Management — Replaces your receptionist and software.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang={REGION_DEFAULTS.lang} dir={REGION_DEFAULTS.dir} suppressHydrationWarning>
      <head>
