...
const LanguageContext = createContext<LanguageContextValue>({
  lang: REGION_DEFAULTS.lang, setLang: () => {}, t: (k) => k, dir: REGION_DEFAULTS.dir, isRTL: REGION_DEFAULTS.dir === 'rtl',
});

function getInitialLang(): Lang {
  if (IS_SOLO_EDITION) return 'en';
  if (typeof window === 'undefined') return REGION_DEFAULTS.lang;
