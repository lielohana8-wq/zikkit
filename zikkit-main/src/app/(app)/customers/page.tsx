...
import SoloCustomers from '@/features/solo/pages/SoloCustomers';
...
export default function CustomersPageRouter() {
  return IS_SOLO_EDITION ? <SoloCustomers /> : <LegacyCustomersPage />;
}
