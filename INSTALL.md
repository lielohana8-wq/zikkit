...
**Dispatcher = לידים בלבד** — התפקיד הזה רואה **רק** את עמוד Leads. לא עבודות, לא לקוחות, לא הצעות, לא קבלות, לא סגירות, לא דוחות, לא מחירון, לא הגדרות. האכיפה בשלוש שכבות: תפריט, ראוטים (כל כתובת אחרת מחזירה אותו ל-Leads), ו-**Firestore Rules** — גם אם יפתח קונסול, השאילתות לשאר האוספים ייחסמו. שכבת הנתונים שלו בכלל לא נרשמת לשום אוסף חוץ מ-`leads`.
...
|---|---|---|---|---|
| לידים | ✔ | — | ✔ (הכל) | — |
| עבודות | הכל | שלו בלבד | — | שלו בלבד |
| סגירות | הכל | שלו בלבד | — | שלו בלבד |
| לקוחות / הצעות / קבלות | ✔ | — | — | — |
| דוחות / אחוזים / מחירון | ✔ | — | — | — |
| צוות / הגדרות | ✔ | — | — | — |
